...
`2c Ts` for 2♣️ (Deuce of Clubs) and T♠️ (Ten of Spades), etc.

Optionally specify the board cards as space seperated card aliases, e.g. `-b 2c Ts 4d 5h` 
for 2♣️ (Deuce of Clubs), T♠️ (Ten of Spades), 4♦️ (Four of Diamonds) and 5♥️ (Five of Hearts) as the turn etc.

Optionally specify the dead cards (the cards that are no longer in the deck) as space 
seperated card aliases, e.g. `-d 10c 2c` for 10♣️ (Ten of Clubs) and 2♣️ (Deuce of Clubs).
...
the dead cards are K♥️ (King of Hearts) and 2♣️ (Deuce of Clubs).
